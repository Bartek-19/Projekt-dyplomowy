...
public final class ExerciseDao_Impl implements ExerciseDao {
  ...
  public ExerciseWithDetails getExerciseDetails(final int id) {
    ...
    return DBUtil.performBlocking(__db, true, true, (_connection) -> {
      ...
      try {
        ...
        _stmt.reset();
        __fetchRelationshipexerciseTargetMuscleGroupAsplPollubAndroidPowerstrongappModelEntityExerciseTargetMuscleGroup(_connection, _collectionTargetMuscleGroups);
        __fetchRelationshipexerciseHasMovementPatternAsplPollubAndroidPowerstrongappModelEntityExerciseHasMovementPattern(_connection, _collectionMovementPatterns);
        __fetchRelationshipexerciseCategoryAsplPollubAndroidPowerstrongappModelEntityExerciseCategory(_connection, _collectionCategory);
  ...
  private void __fetchRelationshipexerciseTargetMuscleGroupAsplPollubAndroidPowerstrongappModelEntityExerciseTargetMuscleGroup(
    ...
    if (_map.size() > 999) {
      RelationUtil.recursiveFetchLongSparseArray(_map, true, (_tmpMap) -> {
        __fetchRelationshipexerciseTargetMuscleGroupAsplPollubAndroidPowerstrongappModelEntityExerciseTargetMuscleGroup(_connection, _tmpMap);
  ...
  private void __fetchRelationshipexerciseHasMovementPatternAsplPollubAndroidPowerstrongappModelEntityExerciseHasMovementPattern(
      @NonNull final SQLiteConnection _connection,
    ...
    if (_map.size() > 999) {
      RelationUtil.recursiveFetchLongSparseArray(_map, true, (_tmpMap) -> {
        __fetchRelationshipexerciseHasMovementPatternAsplPollubAndroidPowerstrongappModelEntityExerciseHasMovementPattern(_connection, _tmpMap);
        return Unit.INSTANCE;
      });
      return;
    }
  ...
  private void __fetchRelationshipexerciseCategoryAsplPollubAndroidPowerstrongappModelEntityExerciseCategory(
      @NonNull final SQLiteConnection _connection,
    ...
    if (_map.size() > 999) {
      RelationUtil.recursiveFetchLongSparseArray(_map, false, (_tmpMap) -> {
        __fetchRelationshipexerciseCategoryAsplPollubAndroidPowerstrongappModelEntityExerciseCategory(_connection, _tmpMap);
        return Unit.INSTANCE;
      });
      return;
    }
