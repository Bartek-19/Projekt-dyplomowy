...
public final class TrainingDayDao_Impl implements TrainingDayDao {
  ...
  public TrainingDayWithExercises getDayWithExercises(final int id) {
    ...
    return DBUtil.performBlocking(__db, true, true, (_connection) -> {
      ...
      try {
        ...
        _stmt.reset();
        __fetchRelationshipplannedExerciseAsplPollubAndroidPowerstrongappModelEntityPlannedExercise(_connection, _collectionPlannedExercises);
  ...
  private void __fetchRelationshipplannedExerciseAsplPollubAndroidPowerstrongappModelEntityPlannedExercise(
    ...
    if (_map.size() > 999) {
      RelationUtil.recursiveFetchLongSparseArray(_map, true, (_tmpMap) -> {
        __fetchRelationshipplannedExerciseAsplPollubAndroidPowerstrongappModelEntityPlannedExercise(_connection, _tmpMap);
