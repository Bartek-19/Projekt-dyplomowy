...
public final class TrainingPlanDao_Impl implements TrainingPlanDao {
  ...
  public TrainingPlanWithDays getPlanWithDays(final int id) {
    ...
    return DBUtil.performBlocking(__db, true, true, (_connection) -> {
      ...
      try {
        ...
        _stmt.reset();
        __fetchRelationshiptrainingDayAsplPollubAndroidPowerstrongappModelEntityTrainingDay(_connection, _collectionTrainingDays);
  ...
  private void __fetchRelationshiptrainingDayAsplPollubAndroidPowerstrongappModelEntityTrainingDay(
    ...
    if (_map.size() > 999) {
      RelationUtil.recursiveFetchLongSparseArray(_map, true, (_tmpMap) -> {
        __fetchRelationshiptrainingDayAsplPollubAndroidPowerstrongappModelEntityTrainingDay(_connection, _tmpMap);
