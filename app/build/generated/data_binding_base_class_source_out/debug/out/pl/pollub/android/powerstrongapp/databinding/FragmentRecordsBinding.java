...
public final class FragmentRecordsBinding implements ViewBinding {
  ...
  private FragmentRecordsBinding(@NonNull LinearLayout rootView, @NonNull ListView listView) {
  ...
  public static FragmentRecordsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRecordsBinding((LinearLayout) rootView, listView);
    }
